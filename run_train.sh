...
CUDA_VISIBLE_DEVICES=0 python train2hide_prompt_random_fast16_sh.py --fealist sh,opacity,rotation,xyz,scale --prompt "NobodysGonnaKnow" --save_path output/single_secret/$cover_item --all_path output/mipnerf360/$secret_item/point_cloud/iteration_30000/point_cloud.ply --source_path_secret data/mipnerf360/$secret_item --hide_path output/mipnerf360/$cover_item/point_cloud/iteration_30000/point_cloud.ply
