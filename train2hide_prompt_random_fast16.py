...
def training(prompt, random_prompts, dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations,
             ...
             allply:str, hideply:str, device, fealist, w1, w2, w3,
    ...
    # prepare the gaussian remain as the cover gt
    ...
    #init gaussians for train
    gaussians = GaussianModel(dataset.sh_degree, device)
    scene = SceneLoadBoth(dataset, gaussians, device) 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--prompt", type=str, default=None, help="Path to load the prompt")
    ...
    training(prompt,random_prompts, lp.extract(args), op.extract(args), pp.extract(args), args.test_iterations,
             ...
             args.save_path,
             args.all_path, args.hide_path, device, fealist, args.w1, args.w2,args.w3,
